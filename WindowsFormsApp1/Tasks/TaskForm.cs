        ...
        public void LetsChange()
        {
            ...
            switch (RichID.ID)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    richTextBox1.Text = "Дано: файл 5 мегабайт.\nНайти: его вес выраженный в килобайтах.\n";//m2
                    break;
                case 6:
                    richTextBox1.Text = "Дано: число 65035 в десятиричной системе счисления.\nНайти его в восьмеричной системе счисления.\n";//m2
                    break;
            }
        }
